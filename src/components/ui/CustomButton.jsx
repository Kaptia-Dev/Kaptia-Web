export default function CustomButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`${primaryColor} ${animate} text-kaptia-primary-blue px-12 py-2 text-[1.2rem] font-bold rounded-full relative shadow cursor-pointer duration-300 overflow-hidden group`}
    >
      <span
